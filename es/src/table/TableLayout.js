...
var TableLayout = function (_Component) {
  ...
  TableLayout.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    var preHeight = height || maxHeight;
  ...
  TableLayout.prototype.scheduleLayout = function scheduleLayout() {
    ...
    this.setState(this.calculateWidth(), function () {
      _this3.updateHeight();
  ...
  TableLayout.prototype.calculateWidth = function calculateWidth() {
    var _props2 = this.props,
        _props2$tableStoreSta = _props2.tableStoreState,
        columns = _props2$tableStoreSta.columns,
        fixedColumns = _props2$tableStoreSta.fixedColumns,
        rightFixedColumns = _props2$tableStoreSta.rightFixedColumns,
        fit = _props2.fit;
