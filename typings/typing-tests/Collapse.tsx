    ...
    return (
      <div>
        ...
        <Collapse accordion={true} value="32" onChange={this.onChange}>
          <Collapse.Item onClick={this.onClick} isActive={true} title={true ? 'title' : (<div>title</div>)}
                         name="name">item</Collapse.Item>
        </Collapse>
        ...
        <CollapseNext accordion={true} value="32" onChange={this.onChange}>
          <CollapseNext.Item onClick={this.onClick} isActive={true} title={true ? 'title' : (<div>title</div>)}
                             name="name">item</CollapseNext.Item>
        </CollapseNext>
      </div>
    );
  }
