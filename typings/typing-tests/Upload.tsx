  ...
  render() {
    ...
    return (
      <div>
        ...
        <Upload action={action} headers={{xAuth: 'jjdsa-dsad'}} data={{}} multiple={true} name="name"
                withCredentials={true} showFileList={true} autoUpload={true} accept="POST" drag={true}
                listType="picture-card" tip={(<div>tip</div>)} trigger={(<div>trigger</div>)} />
        ...
        <UploadNext action={action} headers={{xAuth: 'jjdsa-dsad'}} data={{}} multiple={true} name="name"
                    withCredentials={true} showFileList={true} autoUpload={true} accept="POST" drag={true}
                    listType="picture-card" tip={(<div>tip</div>)} trigger={(<div>trigger</div>)} />
      </div>
    );
