  ...
  render() {
    return (
      <div>
        ...
        <Popover width={100} placement="right-end" trigger="hover" title="title" content="content" popperClass="class"
                 transition="transition" visible={true} visibleArrow={true}>内容</Popover>
        ...
        <PopoverNext width={100} placement="right-end" trigger="hover" title="title" content="content"
                     popperClass="class" transition="transition" visible={true} visibleArrow={true}>内容</PopoverNext>
      </div>
    );
  }
}
