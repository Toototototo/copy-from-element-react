  ...
  render() {
    return (
      <div>
        ...
        <Switch value="1" disabled={true} width={100} onIconClass="el" offIconClass="el" onText="" offText=""
                onColor="red" offColor="blue" onValue="0" offValue="2" name="name" onChange={this.onChange} />
        ...
        <SwitchNext value="1" disabled={true} width={100} onIconClass="el" offIconClass="el" onText="" offText=""
                    onColor="red" offColor="blue" onValue="0" offValue="2" name="name" onChange={this.onChange} />
      </div>
    );
  }
