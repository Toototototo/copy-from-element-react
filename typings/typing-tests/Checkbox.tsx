  ...
  render() {
    return (
      <div>
        ...
        <Checkbox.Group min={2} max={5} size="small" fill="red" textColor="red" value={this.state.value}
                        onChange={this.onChange}>
          <Checkbox label="label" trueLabel={1} falseLabel={2} disabled={true} checked={false} indeterminate={true}
                    focus={true} onChange={this.onChange} />
          <Checkbox.Button>Button</Checkbox.Button>
        </Checkbox.Group>
        ...
        <CheckboxNext.Group min={2} max={5} size="small" fill="red" textColor="red" value={this.state.value}
                            onChange={this.onChange}>
          <CheckboxNext label="label" trueLabel={1} falseLabel={2} disabled={true} checked={false} indeterminate={true}
                        focus={true} onChange={this.onChange} />
          <CheckboxNext.Button>Button</CheckboxNext.Button>
        </CheckboxNext.Group>
      </div>
