  ...
  render() {
    return (
      <div>
        ...
        <InputNumber defaultValue={2} value={3} step={1} max={10} min={1} disabled={true} controls={true} size="small"
                     onChange={this.onChange} />

        <InputNumberNext className="className" style={{width: 100}} />
        <InputNumberNext size="large" step="1" max="10" min="1" />
        <InputNumberNext defaultValue={2} value={3} step={1} max={10} min={1} disabled={true} controls={true}
