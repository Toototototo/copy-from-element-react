  ...
  render() {
    return (
      <div>
        ...
        <Tabs type="border-card" activeName="active" value="value" closable={true} addable={true} editable={true}
              onTabClick={this.onTabClick} onTabRemove={this.onTabRemove} onTabAdd={this.onTabAdd}
        ...
        <TabsNext type="border-card" activeName="active" value="value" closable={true} addable={true} editable={true}
                  onTabClick={this.onTabClick} onTabRemove={this.onTabRemove} onTabAdd={this.onTabAdd}
                  onTabEdit={this.onTabEdit}>
