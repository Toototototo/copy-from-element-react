  ...
  render() {
    return (
      <div>
        ...
        <Progress percentage={10} type="circle" status="exception" strokeWidth={2} width={120} textInside={true}
                  showText={false} />
        ...
        <ProgressNext percentage={10} type="circle" status="exception" strokeWidth={2} width={120} textInside={true}
                      showText={false} />
      </div>
    );
  }
