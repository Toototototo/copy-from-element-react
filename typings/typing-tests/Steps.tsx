    ...
    return (
      <div>
        ...
        <Steps space={100} active={1} direction="vertical" finishStatus="wait" processStatus="wait">
          <Steps.Step title="步骤 1" description="啥" status="wait" direction="vertical" style={{padding: '10px'}}
                      lineStyle={{padding: '10px'}} stepNumber={2} />
        </Steps>
        ...
        <StepsNext space={100} active={1} direction="vertical" finishStatus="wait" processStatus="wait">
          <StepsNext.Step title="步骤 1" description="啥" status="wait" direction="vertical" style={{padding: '10px'}}
                          lineStyle={{padding: '10px'}} stepNumber={2} />
        </StepsNext>
      </div>
    );
