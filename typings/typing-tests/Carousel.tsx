  ...
  render() {
    return (
      <div>
        ...
        <Carousel initialIndex={1} height="200" trigger="click" autoplay={true} interval={3000}
                  indicatorPosition="outside" indicator={true} arrow="never" type="card" onChange={this.onChange}>
        ...
        <CarouselNext initialIndex={1} height="200" trigger="click" autoplay={true} interval={3000}
                      indicatorPosition="outside" indicator={true} arrow="never" type="card" onChange={this.onChange}>
