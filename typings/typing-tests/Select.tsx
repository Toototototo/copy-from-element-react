  ...
  render() {
    return (
      <div>
        ...
        <Select value="2" size="large" disabled={true} clearable={true} filterable={true} loading={true} remote={true}
                remoteMethod={this.remoteMethod} filterMethod={this.filterMethod} multiple={true}
        ...
        <SelectNext value="2" size="large" disabled={true} clearable={true} filterable={true} loading={true}
                    remote={true} remoteMethod={this.remoteMethod} filterMethod={this.filterMethod} multiple={true}
                    placeholder={'placeholder'} onChange={this.onChange}>
          <SelectNext.OptionGroup label="label">
            <SelectNext.Option value="1" label={true ? "label" : 2} selected={true}
                               disabled={true}>haha</SelectNext.Option>
          </SelectNext.OptionGroup>
        </SelectNext>
      </div>
    );
