  ...
  render() {
    return (
      <div>
        ...
        <Menu mode="horizontal" defaultActive="1" defaultOpeneds={[ '1', '2' ]} theme="light" uniqueOpened={true}
              menuTrigger="hover" onSelect={this.onSelect} onOpen={this.onOpen} onClose={this.onClose}>
        ...
        <MenuNext mode="horizontal" defaultActive="1" defaultOpeneds={[ '1', '2' ]} theme="light" uniqueOpened={true}
                  menuTrigger="hover" onSelect={this.onSelect} onOpen={this.onOpen} onClose={this.onClose}>
